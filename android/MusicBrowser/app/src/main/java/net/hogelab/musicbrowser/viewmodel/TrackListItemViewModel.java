...
public class TrackListItemViewModel {
    ...
    public void setupFromCursor(Cursor cursor) {
        if (cursor != null) {
            setId(Long.parseLong(cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media._ID))));
            ...
            setArtistId(Long.parseLong(cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.ARTIST_ID))));
            ...
            setAlbumId(Long.parseLong(cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Audio.Media.ALBUM_ID))));
